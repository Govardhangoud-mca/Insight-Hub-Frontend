...
const Navbar: React.FC = () => {
  ...
  useEffect(() => {
    ...
    // fallback: listen for storage changes from other tabs
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden bg-orange-500 px-4 pb-4 flex flex-col space-y-4">
            <Link to="/" className="py-2" onClick={() => handleLinkClick("/")}>Home</Link>
            <Link to="/about" className="py-2" onClick={() => handleLinkClick("/about")}>About</Link>
            <Link to="/teachers" className="py-2" onClick={() => handleLinkClick("/teachers")}>Teachers</Link>
            <Link to="/live-sessions" className="py-2" onClick={() => handleLinkClick("/live-sessions")}>Live Sessions</Link>
